...
const BottomNav: React.FC<BottomNavProps> = ({ activePage, onNavigate }) => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[calc(100%-48px)] max-sm:w-[calc(100%-32px)] max-w-sm md:max-w-lg lg:max-w-xl glass-card rounded-[2.5rem] py-4 px-8 md:px-12 flex justify-between items-center z-50 transition-all font-sans shadow-apple-lg border-t-white/90 dark:border-t-white/10">
      <div
