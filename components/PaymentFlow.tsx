...
const PaymentFlow: React.FC<PaymentFlowProps> = ({ onBack, onPaymentSuccess, currentBalance, isDarkMode, initialTab = 'SEND', persona, onNavigate }) => {
    ...
    const renderHeader = () => (
        <div className="px-6 py-4 flex items-center justify-between border-b border-slate-100 dark:border-zinc-800 bg-white/95 dark:bg-zinc-950/90 backdrop-blur-md sticky top-0 z-20">
